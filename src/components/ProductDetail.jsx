...
//       title: product.title,
//       price: product.price,
//       image: product.image || product.thumbnail, // support both
    ...
    fetch(apiUrl)
      ...
      .then((data) => {
        ...
        const normalizedData = {
          ...
          image:
            data.image || data.thumbnail || data.images?.[0] || "", // fallback to empty string
          rating: {
            rate: data.rating?.rate || data.rating || 4.2, // dummyjson gives just a number
          },
        };
